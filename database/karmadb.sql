...
CREATE TABLE IF NOT EXISTS `answers` (
  ...
  `answer_text` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `questions` (
  `question_id` int NOT NULL,
  `quiz_id` int NOT NULL,
  `question_text` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
--
-- Table structure for table `quiz_blogs`
--
...
CREATE TABLE IF NOT EXISTS `quiz_blogs` (
  ...
  `quiz_title` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `quiz_description` text CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `quiz_img` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `date_created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`quiz_id`)
) ENGINE=MyISAM AUTO_INCREMENT=91 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;

--
-- Dumping data for table `quiz_blogs`
--
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `username` varchar(55) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
(16, 'long ', 'email@admin.com', '$2y$10$Pyn8.HzgjVhfH.K3Dk5ac.6RnJ.DPT.bd9z061ZgiCfpw/Qg1qAJa', 2, '2023-06-11 22:47:28', NULL);
COMMIT;
